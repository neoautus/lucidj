	...
	implements Runnable, ConsoleInterface,Serializable
{
	...
	*/
	...
	public Object eval(Reader in, NameSpace nameSpace, String sourceFileInfo)
		throws EvalError
	{
		return (eval (in, out, err, nameSpace, sourceFileInfo));
	}

    public Object eval(Reader in, PrintStream pout, PrintStream perr,
					   NameSpace nameSpace, String sourceFileInfo
					   /*, CallStack callstack */ )
		throws EvalError 
	{
		Object retVal = null;
		...
		*/
        Interpreter localInterpreter = 
			new Interpreter( 
				in, pout, perr, false, nameSpace, this, sourceFileInfo  );

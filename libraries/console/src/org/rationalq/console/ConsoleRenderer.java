...
public class ConsoleRenderer implements Renderer
{
    ...
    public boolean compatibleObject (Object obj_to_check)
    {
        ...
        return (obj_to_check instanceof org.rationalq.console.Console);
    }
    ...
    {
        String safe_string = SafeHtmlUtils.htmlEscape (console.getContent ());
        String html = "<div style=\"font: 14px/normal 'Monaco', 'Menlo', 'Ubuntu Mono', 'Consolas', 'source-code-pro', monospace\">" +
                      safe_string.replace ("\n", "<br />") + "</div>";

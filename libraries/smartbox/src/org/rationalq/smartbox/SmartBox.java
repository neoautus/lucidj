...
import org.lucidj.objectmanager.ObjectManagerProperty;
import org.lucidj.task.TaskContext;
import org.rationalq.console.Console;
...
public class SmartBox implements Quark, ComponentInterface, ObjectManagerProperty, ComponentState
{
    ...
    private void init ()
    {
        tctx = TaskContext.currentTaskContext ();

        log.info ("tctx = {}", TaskContext.currentTaskContext ());
        ...
        sh.dynamicVariableListener (new BeanShell.DynamicVariableListener ()
        {
                    ...
                    throws NoSuchFieldException
            {
                ...
                else if (SystemAPI.getCurrent ().getPublishedObject (varname) != null)
                {
                    return (SystemAPI.getCurrent ().getPublishedObject (varname));
                }
    ...
    {
        log.info ("TaskContext before = {}", TaskContext.currentTaskContext ());
        tctx.bindThread ();
        log.info ("TaskContext after = {}", TaskContext.currentTaskContext ());

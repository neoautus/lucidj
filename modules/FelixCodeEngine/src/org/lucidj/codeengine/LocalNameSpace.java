...
public class LocalNameSpace extends NameSpace
{
    ...
    private static ThreadLocal<BeanShellEngine> parent_beanshell = new ThreadLocal<> ();
    ...
    public void setBeanShell (BeanShellEngine parent)
    {
        ...
        throws UtilEvalError
    {
        ...
        if (v == null)
        {
            ...
            {
                BeanShellEngine bsl = parent_beanshell.get ();
